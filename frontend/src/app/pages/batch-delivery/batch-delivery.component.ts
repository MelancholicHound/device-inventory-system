...
import { TableBatch } from '../../util/models/TableBatch';
...
export class BatchDeliveryComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    dataSource!: MatTableDataSource<TableBatch>;

    fetchedData!: any;

    toggleBatchForm: boolean = true;
    toggleSupplierForm: boolean = false;
    ...
    ngOnInit(): void {
        let addBatchModal = document.querySelector('.add-batch-modal') as HTMLDivElement;
        let openModal = document.getElementById('open-add-batch') as HTMLButtonElement;
        let closeModal = document.getElementById('close-add-batch') as HTMLButtonElement;
